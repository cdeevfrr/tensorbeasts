...
export default function PartyPlanC({
    ...
    party: PartyPlan,
    setParty: (partyPlan: PartyPlan) => void,
    box: Array<Beast>
}) {
    ...
    return (
      <View style={styles.container}>
        ...
        />
        <BeastRowC beasts={party.vanguard} beastClickCallback={(beast) => {
            setShowBox(true)
            setBeastLocation({
                array: 'vanguard',
        ...
        <BeastRowC beasts={party.core} beastClickCallback={(beast) => {
            setShowBox(true)
            setBeastLocation({
                array: 'core',
        ...
        <BeastRowC beasts={party.support} beastClickCallback={(beast) => {
            setShowBox(true)
            setBeastLocation({
                array: 'support',
